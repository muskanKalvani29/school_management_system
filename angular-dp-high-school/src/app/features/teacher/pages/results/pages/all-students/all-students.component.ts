...
export class AllStudentsComponent implements OnInit {
 ...
 //view ActAch to navigate
   viewResult(grNo:number)
   {
     console.log("view");
     this.router.navigate(['/teacher/result/all-students/view-result',grNo]);
   }
   //Add ActAch Routing
   addResult(grNo:number)
   {
     console.log("view");
     this.router.navigate(['/teacher/result/all-students/add-result',grNo]);
   }
