...
export class AllStudentsComponent implements OnInit {
  ...
  getStudentsByStdAndDiv()
  {
   ...
   //view Attendance to navigate
   viewAttendance(grNo:number)
   {
     console.log("view");
     this.router.navigate(['/teacher/attendance/all-students/view-attendance',grNo]);
   }
   //Add Attendance Routing
   addAttendance(grNo:number)
   {
     console.log("view");
     this.router.navigate(['/teacher/attendance/all-students/add-attendance',grNo]);
   }
}
