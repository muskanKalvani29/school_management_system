...
@Component({
  selector: 'app-error-code500',
  templateUrl: './error-code500.component.html',
  styleUrls: ['./error-code500.component.css']
})
export class ErrorCode500Component implements OnInit {
