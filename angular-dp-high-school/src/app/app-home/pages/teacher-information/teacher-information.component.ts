...
export class TeacherInformationComponent implements OnInit {
  ...
  addTeacher(addTeacher:any)
  {
    ...
    console.log(addTeacher.qualification)
    console.log(addTeacher.gender)
    console.log(addTeacher.joiningDate)
    console.log(addTeacher.address1)
    console.log(addTeacher.address2)
    console.log(addTeacher.pincode)
    ...
    this.teacher.user.userId = this.userId;
    this.getTecharService.addTeacher(this.teacher).subscribe(data=>{
      console.log(data);
